...
const marianaData = {
    ...
    desc: 'The Mariana Trench is the deepest part of the oceans, reaching a maximum known depth of about 10,984 meters (36,037 feet) at the Challenger Deep. It is formed by the subduction of the Pacific Plate beneath the smaller Mariana Plate. The trench is a site of extreme geological activity and is home to unique ecosystems adapted to its high-pressure environment.',
    img: 'img/mariana.jpg',
...
const africaData = {
    ...
    desc: 'The African Rift Valley is a series of rift valleys that stretch from the Afar Triangle in Ethiopia down through Kenya, Tanzania, and into Mozambique. It is a divergent tectonic plate boundary where the African Plate is splitting into two smaller plates, the Somali Plate and the Nubian Plate. This rifting process is responsible for the formation of deep valleys, volcanic activity, and the Great Lakes of Africa.',
...
const himData = {
    ...
    title: 'The Himalayas',
    desc: 'The Himalayas are a mountain range formed by the collision of the Indian Plate with the Eurasian Plate. This convergent plate boundary has resulted in the uplift of the Himalayas, which include some of the highest peaks in the world, such as Mount Everest. The ongoing tectonic activity in this region continues to shape the landscape and contributes to seismic activity.',
    img: 'img/Everest.jpg',
